...
export class MedusaOralArms {
    ...
    static createMaterial(physics) {
        ...
        MedusaOralArms.material.opacityNode = Fn(() => {
            ...
            return smoothstep(0.03, 0.18, uv().y).mul(0.82).mul(fog);
        })();
        ...
        MedusaOralArms.material.colorNode = Fn(() => {
            ...
            const white = vec3(0.76,0.92,1.0).sub(noise);
            const orange = vec3(0.08,0.54,1.0).sub(noise);
            const red = vec3(0.12,0.92,0.86).sub(noise);
        ...
        MedusaOralArms.material.emissiveNode = Fn(() => {
            const red = vec3(0.12,0.92,0.86);
            const orange = vec3(0.08,0.54,1.0);
