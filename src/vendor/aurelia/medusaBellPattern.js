...
export class MedusaBellPattern {
    static createColorNode() {
        ...
        MedusaBellPattern.colorNode = Fn(() => {
            ...
            const white = vec3(0.72,0.92,1.0) - noise;
            const orange = vec3(0.08,0.34,0.68) - noise;
            const red = vec3(0.48,0.28,0.82) - noise;
            ...
            MedusaBellPattern.emissiveness.addAssign(red * value.y * 0.075);
