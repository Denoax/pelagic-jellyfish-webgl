...
export const asset2Paths=['src/scene/HeroScene.jsx','src/scene/PelagicEnvironment.js',
 'src/scene/environment/Asset2Environment.js','src/scene/environment/asset2Layout.js','src/scene/environment/asset2Config.js','src/scene/environment/Asset2AOProof.js'];
