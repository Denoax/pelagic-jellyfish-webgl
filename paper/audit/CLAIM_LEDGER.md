...
| C11 | Runtime performance | benchmark-proven only after fresh capture-free runs | Historical tables do not establish publication performance. Report raw intervals, stalls and settings. |
