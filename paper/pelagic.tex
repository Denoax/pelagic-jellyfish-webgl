...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 1. Approved-runtime overview: luminous procedural tissue within the shared ocean. Actual browser capture; camera state and renderer metadata accompany the figure.}]{figures/F01-overview.jpg}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 2. Ownership and frame composition. Auxiliary field/output draws are not additional ocean scene renders.}]{figures/F02-system.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 3. Mantle coordinates and folded section, plotted from the approved functions rather than traced from a screenshot.}]{figures/F03-anatomy.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 4. Source-derived pulse curves and phase samples: contraction, refill and coast are intentionally unequal.}]{figures/F04-pulse.png}}
\caption{Figure 4. Source-derived pulse curves and phase samples:
contraction, refill and coast are intentionally unequal.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 5. Persistent chain history, length projection and reconstructed membrane/tube surfaces.}]{figures/F05-appendages.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 6. Projected-size detail thresholds and geometric transition policy. CSS-pixel thresholds do not change when DPR changes.}]{figures/F06-lod.png}}
\caption{Figure 6. Projected-size detail thresholds and geometric
transition policy. CSS-pixel thresholds do not change when DPR changes.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 7. Shared clean-image compositor. The output is never sampled as its own input; idle field ping-pong stores state, not ocean color.}]{figures/F07-compositor.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 8. Ray--ellipsoid entry, exit and bounded live-image lookup; the virtual background plane is an approximation, not scene reconstruction.}]{figures/F08-refraction.png}}
\caption{Figure 8. Ray--ellipsoid entry, exit and bounded live-image
lookup; the virtual background plane is an approximation, not scene
reconstruction.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 9. Approved sanctuary at the publication runtime: procedural geology, localized plume and restrained life.}]{figures/F09-sanctuary.jpg}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 10. Normal-size clock contact and merge sequence. The supplement records actual timing and warns against interpreting the authored neck as conserved fluid.}]{figures/F10-contact.jpg}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 11. Throat narrowing, separation and recovery during approved M7.2 dismissal. Actual browser frames, not generated liquid artwork.}]{figures/F11-pinch.jpg}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 12. Fresh publication-runtime frame-interval distributions. Labels identify scene and measurement conditions; no screenshot/video work runs during timing.}]{figures/F12-performance.png}}
\caption{Figure 12. Fresh publication-runtime frame-interval
distributions. Labels identify scene and measurement conditions; no
