...
Copyright © 2026 Mani Marami Milani, for original contributions to the extent copyright applies.

- Original software source, including publication tooling and project-page code: [MIT](LICENSES/MIT.txt).
- Original paper, documentation, explanatory diagrams, screenshots and project-generated publication media: [Creative Commons Attribution 4.0 International](LICENSES/CC-BY-4.0.txt).
- Third-party code, fonts, models, textures and other components retain their original terms. See [ASSET_PROVENANCE.md](ASSET_PROVENANCE.md) and retained notices. This policy does not relicense those contributions or grant rights the author does not hold.
