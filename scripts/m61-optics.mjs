...
try{
 ...
 await b.ev(`window.__CAMERA_LAB__.select('explore');const c=window.__CAMERA_LAB__.camera;c.position.set(-4.2,-2.1,-25.7);c.lookAt(-4.26,-2.1,-23.95);c.updateMatrixWorld()`);
