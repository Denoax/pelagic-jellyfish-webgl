...
const root=process.env.M66_PERF_ROOT||'/home/mani/dev/jellyfish-studio/m6-6-evidence/performance';
for(const name of process.env.M66_SCENES?.split(',')||['wide','stationary','orbit','near-floor','illumination','portrait']){
 let pose='';
