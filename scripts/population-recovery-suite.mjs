...
const url = `http://127.0.0.1:${side === 'before' ? 5188 : 5189}/?populationLod=1&bubblePassage=1&renderer=webgl&idle=300`;
...
} else if (suite === 'matched') for (const [scene, progress] of cases.filter(c => c[1] !== null)) {
